...
function getWeatherData(city, unit, hourlyorWeek) {
  console.log(city);
  const apiKey = "HPH5ZBHBD9XGQXCBXWYYZQQBG";

  fetch( `https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/delhi?unitGroup=metric&key=HPH5ZBHBD9XGQXCBXWYYZQQBG&contentType=json`,
    {
      method: "GET",
    }
  )
